...
Dokumen ini menjelaskan semua _endpoint_ API yang tersedia untuk backend aplikasi kesehatan BE-RESTRO.

**Base URL:** `https://be-restro-api-fnfpghddbka7d4aw.eastasia-01.azurewebsites.net`

**Format Data Umum:**

* *   _Request body_ untuk `POST` dan `PUT` umumnya menggunakan format `application/json`, kecuali untuk _upload_ file yang menggunakan `multipart/form-data`.
*     
* *   _Response body_ selalu dalam format `application/json`.
*     

**Autentikasi:**

* *   Sebagian besar _endpoint_ memerlukan autentikasi menggunakan JSON Web Token (JWT).
*     
* *   Kirim token JWT di _header_ `Authorization` dengan format `Bearer <TOKEN_ANDA>`.
*     

## 1\. API untuk Semua Pengguna (Terapis & Pasien)

Bagian ini berisi _endpoint_ yang dapat diakses oleh pengguna dengan peran Terapis maupun Pasien, setelah mereka terautentikasi.

### 1.1 Autentikasi (`/auth`)

_Endpoint_ yang berkaitan dengan registrasi, _login_, dan _logout_ pengguna.
...
*     *     
*     * *   `409 Conflict`: _Username_ atau _email_ sudah terdaftar.
*     *     
*     * *   `500 Internal Server Error`: Kesalahan _server_.
*     *     
...
*     
* *   **Deskripsi:** _Login_ untuk pengguna terapis.
*     
* *   **Headers:**
*     
*     * *   `Content-Type: application/json`
...
* *   **Response Error:**
*     
*     * *   `400 Bad Request`: _Identifier_ atau _password_ tidak diisi.
*     *     
*     * *   `401 Unauthorized`: _Identifier_ atau _password_ salah.
*     *     
...
*     
* *   **Deskripsi:** _Login_ untuk pengguna pasien.
*     
* *   **Headers:**
*     
*     * *   `Content-Type: application/json`
...
*     
* *   **Deskripsi:** Mendapatkan data ringkasan lengkap untuk _dashboard_ monitoring pasien (KPI, tren, distribusi hasil gerakan, catatan terbaru, dan riwayat aktivitas).
*     
* *   **URL Parameters:**
*     
...
*     * *   `401 Unauthorized`: Token tidak valid.
*     *     
*     * *   `403 Forbidden`: Pengguna tidak berhak melihat _summary_ ini.
*     *     
...
Bagian ini berisi _endpoint_ yang khusus ditujukan untuk pengguna dengan peran Pasien.

### 2.1 Profil Pasien (`/api/patient`)

_Endpoint_ yang berkaitan dengan data profil pasien.
...
*     
* *   **Deskripsi:** Mendapatkan detail profil lengkap dari pasien yang sedang _login_.
*     
* *   **Headers:**
*     
...
* *   **URL:** `/api/patient/profile`
*     
* *   **Deskripsi:** Memperbarui detail profil pasien yang sedang _login_.
*     
* *   **Headers:**
*     
*     * *   `Authorization: Bearer <TOKEN_PASIEN>`
...
*     * *   `Content-Type: application/json`
*     *     
* *   **Request Body** (kirim hanya _field_ yang ingin diubah):
*     
*     ```
*     {
...
*     * *   `404 Not Found`: Profil pasien tidak ditemukan.
*     *     
*     * *   `409 Conflict`: _Username_, _email_, atau nomor telepon baru sudah digunakan.
*     *     
...
_Endpoint_ untuk pasien melihat programnya.
...
_Endpoint_ untuk pasien mengirimkan hasil pelaksanaan program dan untuk melihat laporan.
...
_Endpoint_ untuk pasien melihat badge yang mereka dapatkan.
...
Bagian ini berisi _endpoint_ yang khusus ditujukan untuk pengguna dengan peran Terapis.

### 3.1 Manajemen Gerakan (`/api/gerakan`)

_Endpoint_ untuk terapis mengelola perpustakaan gerakan rehabilitasi.
...
* *   **Response Error:**
*     
*     * *   `400 Bad Request`: Data _form_ tidak lengkap, format file salah, atau _error upload_.
*     *     
*     * *   `401 Unauthorized`: Token tidak valid.
*     *     
...
*     * *   `Content-Type: multipart/form-data`
*     *     
* *   **Request Body:** `form-data` (kirim _field_ yang ingin diubah, termasuk file jika ingin mengganti)
*     
...
_Endpoint_ untuk terapis membuat dan meng-assign program.
...
_Endpoint_ untuk terapis melihat laporan.
...
_Endpoint_ khusus untuk terapis mengelola pola makan pasien.
...
*     
* *   **Deskripsi:** Mendapatkan data ringkasan KPI dan data grafik untuk _dashboard_ terapis.
*     
* *   **Headers:**
*     
*     * *   `Authorization: Bearer <TOKEN_TERAPIS>`
...
_Endpoint_ untuk terapis mengelola badge.
